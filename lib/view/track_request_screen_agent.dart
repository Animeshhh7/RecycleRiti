...
class _TrackRequestScreenAgentState extends State<TrackRequestScreenAgent> with SingleTickerProviderStateMixin {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      NotificationScreen.initNotifications(
        ...
        onNotificationReceived: () {
          print('TrackRequestScreenAgent: Notification received, refreshing data');
    ...
    try {
      ...
      if (response['success']) {
        setState(() {
          ...
          print('TrackRequestScreenAgent: Fetched current agent ID: $currentAgentId');
        });
      }
    } catch (e) {
      print('TrackRequestScreenAgent: Failed to fetch current agent ID - $e');
      ExceptionHandling.showSnackBar(context, 'Failed to fetch agent ID: $e');
    }
  }
  ...
  Future<void> _fetchData() async {
    ...
    await ExceptionHandling.handleApiCall<Map<String, dynamic>>(
      ...
      onError: (error) {
        ...
        print('TrackRequestScreenAgent: Error fetching request data: $error');
      },
    );
  ...
  Future<void> _cancelRequest() async {
    ...
    bool isAssignedToAgent = requestData?['assignments']?['agent'] != null && requestData?['assignments']['agent']['id']?.toString() == currentAgentId;
    ...
    await ExceptionHandling.handleVoidApiCall(
      ...
      onSuccess: () {
        ...
        _fetchData();
        print('TrackRequestScreenAgent: Request ${widget.requestId} cancelled successfully');
      },
      onError: (error) {
        ...
        print('TrackRequestScreenAgent: Error cancelling request ${widget.requestId}: $error');
      },
    );
  ...
  Future<void> _markAsCompleted() async {
    ...
    await ExceptionHandling.handleVoidApiCall(
      ...
      onSuccess: () {
        ...
        _fetchData();
        print('TrackRequestScreenAgent: Request ${widget.requestId} marked as completed successfully');
      },
      onError: (error) {
        ExceptionHandling.showSnackBar(context, error);
        print('TrackRequestScreenAgent: Error marking request ${widget.requestId} as completed: $error');
      },
    );
  ...
  Future<void> _makePhoneCall(String? phoneNumber) async {
    ...
    if (await canLaunchUrl(phoneUri)) {
      ...
      print('TrackRequestScreenAgent: Initiated phone call to $phoneNumber');
    } else {
      ExceptionHandling.showSnackBar(context, "Unable to make a phone call");
      print('TrackRequestScreenAgent: Failed to initiate phone call to $phoneNumber');
    }
  }
  ...
  Future<void> _sendMessage(String? phoneNumber) async {
    ...
    if (await canLaunchUrl(smsUri)) {
      ...
      print('TrackRequestScreenAgent: Initiated SMS to $phoneNumber');
    } else {
      ExceptionHandling.showSnackBar(context, "Unable to send a message");
      print('TrackRequestScreenAgent: Failed to initiate SMS to $phoneNumber');
    }
  }
