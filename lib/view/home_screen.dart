...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin, WidgetsBindingObserver {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      NotificationScreen.initNotifications(
        ...
        onNotificationReceived: () {
          setState(() {});
          print('HomeScreen: Notification received, refreshing UI');
        },
      );
    });
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.resumed) {
      final navCtrl = Provider.of<BottomNavController>(context, listen: false);
      navCtrl.resetIndex();
      print('HomeScreen: Resumed, reset tab index to 0');
    }
  }
  ...
  Future<void> _fetchUserProfile() async {
    ...
    await ExceptionHandling.handleApiCall<Map<String, dynamic>>(
      ...
      onSuccess: (response) {
        if (response['success']) {
          setState(() {
            ...
            print('HomeScreen: Successfully fetched user profile - Username: $_username, Role: $_userRole, Profile Image: $_profileImageUrl');
          });
        } else {
      ...
      onError: (error) {
        ...
        print('HomeScreen: Error fetching user profile: $error');
      },
    );
    ...
    return Scaffold(
      appBar: CustomAppBar(
                    ...
                    ? ClipOval(
                        child: CachedNetworkImage(
                          ...
                          errorWidget: (context, url, error) {
                            print('HomeScreen: Error loading profile image - $error');
                            return Icon(
                              Icons.person,
                              color: AppTheme.primaryColor,
                              size: 24,
        ...
        onNotificationStateChanged: () {
          setState(() {});
          print('HomeScreen: Notification state changed, refreshing UI');
        },
      ),
      body: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSectionHeader(
                          ...
                          onActionPressed: () {
                            _navigateToScreen(AppRoutes.recyclingTips);
                          },
                        ),
                        ...
                        _buildSectionHeader(
                          ...
                          actionText: "Learn More",
                          onActionPressed: () {
                            _navigateToScreen(AppRoutes.eventParticipation);
                          },
                        ),
                        const SizedBox(height: 16),
                        _buildImageSlider(
  ...
  void _navigateToScreen(String route) {
    try {
      ...
      print('HomeScreen: Navigated to $route');
    } catch (e) {
      print('HomeScreen: Navigation error to $route: $e');
      ExceptionHandling.showSnackBar(context, 'Navigation failed: $e');
    }
  }
            ...
            return ClipRRect(
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  print('HomeScreen: Error loading slider image at index $index - $error');
                  return Container(
                    color: AppTheme.cardColor,
                    child: Center(
                      child: Column(
