// lib/view/recycling_tips_screen.dart
import 'dart:io';
...
class _RecyclingTipsScreenState extends State<RecyclingTipsScreen> with SingleTickerProviderStateMixin {
                    ...
                    if (existingBlog != null) {
                      ...
                      await ExceptionHandling.handleApiCall<Map<String, dynamic>>(
                        ...
                        onSuccess: (data) {
                          ...
                          ExceptionHandling.showSnackBar(context, 'Blog updated successfully');
                          _fetchUserDataAndBlogs(); // Refresh the list
                        },
                      );
                    } else {
                      // Create new blog
                      await ExceptionHandling.handleApiCall<Map<String, dynamic>>(
                        ...
                        onSuccess: (data) {
                          Navigator.pop(context);
                          ExceptionHandling.showSnackBar(context, 'Blog uploaded successfully');
                          _fetchUserDataAndBlogs(); // Refresh the list
                        },
                      );
                    }
