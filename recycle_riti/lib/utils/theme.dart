...
class AppTheme {
  ...
  static const Color appBarColor = primaryColor; // Use primaryColor for AppBar
  static const Color bottomNavBarColor = primaryColor; // Use primaryColor for BottomNavigationBar
  ...
  static const TextStyle appBarTitleStyle = TextStyle(
    ...
    color: textColor,
    letterSpacing: 0.5,
    fontFamily: 'Roboto', // Use a nice font (you can change this to a custom font if desired)
  );
